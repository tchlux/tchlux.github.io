...
! 
! 
! This file contains an implementation of a "multilayer perceptron",
!  or more specifically a piecewise linear regression model fit with
!  a curvature-approximating minimization algorithm. All code here
!  attempts to describe the related concepts with strictly
!  mathematical descriptions of what is being done (not coloquial).
! 
...
CONTAINS
  ...
  ! Evaluate the piecewise linear regression model. Offers two
  ! functionalities based on the shape of the provided OUTPUTS:
  !   - same as output at fit time, run the network forward;
  !   - same as last layer of model, run network forward to transform
  !     data into the "last layer representation".
