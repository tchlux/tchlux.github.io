...
In the process of pursuing structure prediction for AI, I have made a history-based stock futures prediction algorithm. Some sample predictions are available for [DOGE](https://tchlux.github.io/futures/doge.html) and [TSLA](https://tchlux.github.io/futures/tsla.html). I'm working on starting a blog [here](https://tchlux.github.io/research/).
