...
<p align="left" style="margin-left: min(10vw, 50px)">
  ...
  <ul class="social-media-list" style="dislpay: inline;">
    ...
    {%- if social.github -%}<li style="padding: 0px 0px 0px 5px; display: inline-block; width:35px; height:35px;"><a href="https://github.com/{{ social.github | cgi_escape | escape }}" title="Github {{ social.github | escape }}"><svg width="30px" height="30px" viewBox="0 0 30 30" class="svg-icon grey"><use xlink:href="{{ '/assets/minima-social-icons.svg#github' | relative_url }}"></use></svg></a></li>{%- endif -%}
